...
//    }
  ...
  public void setState(SwerveModuleState2 state)
  {
    ...
    state = SwerveModuleState2.optimize(state, currentAngle);
    //double angle = state.angle.getDegrees(); // getDegrees returns in the range of -180 to 180 we want 0 to 360.
